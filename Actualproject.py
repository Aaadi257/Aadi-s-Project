...
ocean_mask = cv2.inRange(hsv, (100, 60, 60), (130, 255, 255))
land_mask = cv2.inRange(hsv, (35, 50, 50), (90, 255, 255))
segmented = img.copy()
segmented[ocean_mask > 0] = (255, 140, 80)
segmented[land_mask > 0] = (50, 255, 150)
cv2.imwrite("segmented_1.jpg", segmented)
...
plt.title('Segmented Ocean and Land')
plt.axis('off')
plt.show()
